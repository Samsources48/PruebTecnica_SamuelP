...
try
{
    ...
    builder.Services.AddScoped<IAuthService, ExternalAuthService>();
    ...
    {
        await context.Response.WriteAsync($"Api Clientes y Pedidos {Assembly.GetExecutingAssembly().GetName().Name!} trabajando");
    });
